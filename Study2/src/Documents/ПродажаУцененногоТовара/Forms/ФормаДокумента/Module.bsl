 ...
 Процедура ПересчитатьСуммуДокумента()
	 ...
	 //Метод “Итог” суммирует все значения указанной колонки 
 ...
 Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	 ...
	 Если ТипЗнч(ВыбранноеЗначение) = Тип("Структура") Тогда
		 ...
		 СообщениеДобавления = СтрШаблон("В Документ продажа уцененного товара %1 от %2 добавлена номенклатура:
	 ...
	 ИначеЕсли ТипЗнч(ВыбранноеЗначение) = Тип("ДокументСсылка.УценкаТовара") Тогда
		 ОбработкаЗаполнения(ВыбранноеЗначение);	 
	 КонецЕсли;	 
 КонецПроцедуры
 ...
 КонецПроцедуры
  ...
  &НаКлиенте
 Процедура ЧастичноеЗаполнение(Команда)
	 
	 ПараметрыФормы = Новый Структура("ЗакрыватьПриВыборе, РежимПодбора", Истина, Истина);
	 ОткрытьФорму("Документ.УценкаТовара.Форма.ФормаВыбора",ПараметрыФормы, ЭтотОбъект);
