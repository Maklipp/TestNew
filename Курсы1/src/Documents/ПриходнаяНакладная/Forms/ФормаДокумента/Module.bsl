 ...
 Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	 ...
	 Если ТипЗнч(ВыбранноеЗначение) = Тип("Структура") Тогда
		 ...
		 СтрокаТаблицы.Количество = ВыбранноеЗначение.Количество + ВыбранноеЗначение.Количество;
		 СтрокаТаблицы.Сумма = СтрокаТаблицы.Количество * СтрокаТаблицы.Цена;
		 ПересчитатьСуммуДокумента();
		 
		 СообщениеДобавления = СтрШаблон("В Документ приходная накладная %1 от %2 добавлена номенклатура:
...
Процедура НоменклатураНоменклатураПриИзменении(Элемент)
		...
		Если СоставНоменклатураПриИзмененииНаСервере(Объект.ДокументОснование, ТекДанные.Номенклатура) Тогда
			Сообщить("Товар " + ТекДанные.Номенклатура + " не был заказан, либо был снят с заказа");
